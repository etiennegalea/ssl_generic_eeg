...
def main(dataset_name, subject_size, subject_size_n, random_state, n_jobs, window_size_s, low_cut_hz, high_cut_hz, sfreq, lr, n_epochs, batch_size, n_channels, connectivity_plot, edge_bundling_plot, plot_heavy, show_plots, load_feature_vectors, load_latest_model, fully_supervised, cv):
    ...
    if load_latest_model:
        ...
        model = torch.load("models/pretrained/2022_04_18__02_05_sleep_staging_5s_windows_83%_subjects_cpu_25_epochs_100hz.model")   # 2000 pair samples, tau_pos = 4
        # model = torch.load("models/pretrained/2022_04_15__00_43_sleep_staging_5s_windows_83%_subjects_cpu_25_epochs_100hz.model")   # 25-dim
