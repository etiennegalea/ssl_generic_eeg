...
# Segmentation parameters (in seconds)
WINDOW_SIZE = 1.0
WINDOW_OVERLAP = 0.5
# Mapping parameters (in seconds)
CUTOFF_LENGTH = 0.1
...
def _segment(Raw, windowSize, windowOverlap):
...
def _map_artifacts(Raw, segments, windowSize, cutoffLength):
